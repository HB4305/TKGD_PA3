...
| :----------------------------------------------- | :----------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Facilitator & Mobile ("Computer Role")** | **Phùng Ngọc Tuấn**   | Đọc kịch bản bối cảnh, giao nhiệm vụ (Task), nhắc nhở người tham gia "think aloud", giữ nhịp độ phiên test mà không mớm ý.<br />Đóng vai hệ thống: tráo đổi, đặt hoặc rút các mảnh giấy prototype/menu/overlay tương ứng khi người dùng chạm tay vào nút. |
| **Observer / Note-taker**                  | **Phạm Chí Bảo Ninh** | Bấm giờ, đếm số lần tap/cuộn, ghi nhận lỗi thao tác, ghi chép nét mặt, sự ngập ngừng và trích dẫn các câu nói của người dùng.                                                                                                                                               |
...
| :-------------: | :------------------------------------ | :--------------------------------- | :------------------------------------------------------------------------------------------------------------------------ |
| **Nav-1** | **Fixed Bottom Navigation Bar** | `img/nav_1.JPG`      | Thanh tab 5 mục (Schedule, Videos, Home, News, More) cố định ở đáy; icon Schedule nằm ngay vùng với ngón cái. |
| **Nav-2** | **Floating Action Button Menu** | `img/nav_2.JPG`      | Nút tròn nổi FAB ở góc dưới bên phải; khi bấm sẽ bung menu vòng cung (radial menu) chứa các lối tắt.      |
| **Nav-3** | **Bottom Hamburger Menu**       | `img/nav_3_menu.JPG` | Nút mở menu ở góc dưới; khi bấm sẽ trượt lên một bảng menu toàn màn hình dạng danh sách dọc.           |

![Home screen paper prototype](img/home.JPG)

![Navigation variant 1 - Bottom navigation](img/nav_1.JPG)

![Navigation variant 2 - FAB/radial menu pieces](img/nav_2.JPG)

![Navigation variant 3 - Bottom hamburger full menu](img/nav_3_menu.JPG)
...
|     Variant     | Tên phương án                      | File prototype                                                                                                                                                             | Mô tả thiết kế                                                                                                                                    |
| :-------------: | :------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Sch-1** | **Accordion + Event Detail**     | `img/schedule_1_default_collapsed.JPGimg/schedule_1_default_expanded.JPG``img/event.JPG`                                           | Thẻ giải đấu có icon mũi tên`▼` mở rộng inline danh sách kỳ thủ/cặp đấu, bấm vào event ngày 10/8 để mở trang chi tiết giải. |
| **Sch-2** | **Past Timeline + Event Detail** | `img/schedule_3_default.JPGimg/schedule_3_scroll_up.JPG``img/event.JPG`                                                            | Danh sách dòng thời gian dọc; người dùng vuốt ngược lên quá khứ để tìm sự kiện ngày 09/06/2020 rồi bấm vào xem chi tiết.       |
| **Sch-3** | **Date Strip + Match Detail**    | `img/schedule_2_default_collapsed.JPGimg/schedule_2_scroll_left.JPG``img/schedule_2_default_expanded.JPGimg/match.JPG` | Dải ngày ngang (Date Strip) chọn nhanh ngày 16/8, mở rộng trận đấu và bấm nút`Detail ->` để xem bàn cờ 8x8 chi tiết.               |

![Schedule variant 1 - Collapsed cards](img/schedule_1_default_collapsed.JPG)
![Schedule variant 1 - Expanded card](img/schedule_1_default_expanded.JPG)
![Schedule variant 1 - Event detail](img/event.JPG)

![Schedule variant 2 - Default timeline](img/schedule_3_default.JPG)
![Schedule variant 2 - Past scroll to 9/6 event](img/schedule_3_scroll_up.JPG)

![Schedule variant 3 - Date filter](img/schedule_2_default_collapsed.JPG)
![Schedule variant 3 - Expanded match card with Detail button](img/schedule_2_default_expanded.JPG)
![Schedule variant 3 - Match detail](img/match.JPG)

---

### 6.1. Mô hình khung điện thoại giấy (Paper Phone Case Simulator)

Tất cả các phiên test đều được tiến hành bên trong khung giấy `img/phone_case.JPG`. Mô hình có khe trượt chuẩn kích thước màn hình smartphone, giúp người tham gia cầm máy bằng một tay như thật và không nhìn thấy các mảnh giấy bên ngoài trước khi thao tác.

![Paper phone case used for testing](img/phone_case.JPG)
